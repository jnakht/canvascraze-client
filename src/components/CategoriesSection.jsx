...
const CategoriesSection = () => {
    return (
        <div className={`h-[calc(100vh-8px)] w-[calc(100vw-20px)] relative mt-[100px]`}>
            {/* upper section start*/}
            <div className="flex flex-col border justify-end items-center text-center h-[300px] space-y-2">
	...
	s1.153,1.471,1.288,4.87c0.08,2.033-1.029,4.825-1.029,4.825l-0.003,0.028l0.35,1.735L23.032,11.538z"></path>
            ...
            {/* borders start*/}
            {/* left border */}
            <div className="bg-[url('https://ik.imagekit.io/ghlgoepam/New%20Folder/h2-border-left.jpg?updatedAt=1746003441583')] bg-no-repeat bg-cover absolute left-0 w-2 h-full">
            </div>
            {/* right border */}
